    ...
    <div className={styles.wrapper}>
      ...
      <Sh
        code={[
          {
            fileName: 'Text.tsx',
            code: require('txt/pages/textInput/examples/Text.txt'),
            language: 'tsx',
          },
        ]}
      />
      <Example code={require('txt/pages/textInput/examples/ExampleRegularAllCases.txt')}>
        ...
        code={[
          {
            ...
            code: require('txt/pages/textInput/examples/TextAntd.txt'),
            language: 'tsx',
          },
        ]}
      />

      <Example code={require('txt/pages/textInput/examples/ExampleAntdAllCases.txt')}>
        <ExampleAntdAllCases />
      </Example>
        ...
        code={[
          {
            ...
            code: require('txt/pages/textInput/examples/TextMantine.txt'),
            language: 'tsx',
          },
        ]}
      />

      <Example code={require('txt/pages/textInput/examples/ExampleMantineAllCases.txt')}>
