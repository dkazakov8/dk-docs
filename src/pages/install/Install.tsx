...
export default function Install() {
  ...
  return (
    <div className={styles.wrapper}>
      <h1>Установка и базовая форма</h1>
      <p>
      ...
      <Sh
        ...
        code={[
          {
            fileName: 'Text.tsx',
            code: require('txt/pages/install/examples/Text.txt'),
            language: 'tsx',
          },
        ]}
      />
      ...
      <Sh
        ...
        code={[
          {
            fileName: 'Form.tsx',
            code: require('txt/pages/install/examples/Form.txt'),
            language: 'tsx',
          },
        ]}
      />
      ...
      <Example code={require('txt/pages/install/examples/ExampleBasic.txt')} openDefault>
        <ExampleBasic />
      </Example>
